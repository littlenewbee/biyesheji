...
<span class="personalinfo">入职人员申请单</span> 
</div>
<div class="container">
<form action="/毕业设计/uploadEntryProcess"method="get">
	<input type="hidden" name="employeeNum" value="${precord.employeeNum }"/>
	<input type="hidden" name="type" value="entry"/>
	<textarea class="t2" rows="40" cols="60" name="description" placeholder="对入职员工情况的描述:"></textarea>
	<input type="submit" name="tijiao" value="提交"/><input type="button" name="return" class="qingkong" value="清空"/>
</form>
</div>
<div class="pop">
对不起，你不具有相应的权限
...
<script type="text/javascript" src="/毕业设计/js/DismissionProcess.js"></script>
