...
<header>
	<div class="header">
		...
		<span class="title_con">惩罚管理</span>
		<span class="title_con1">欢迎   ${precord.employeeName }</span>
		<a class="logout" href="/毕业设计/login/login.html">LogOut</a>
	</div>
</header>
<div class="tips">请正确填写好被惩罚人员的信息及描述</div>
<form action="/毕业设计/uploadPunishmentManagement" method="get" >
<div class="con_input">
...
<div class="con_input">
	<span>惩罚日期：</span><input type="text" name="punishTime" class="easyui-datebox"/><br>
</div>
<div class="con_input">
	<span>惩罚描述：</span>
</div>
<textarea class="t2" rows="15" cols="50" name="punishDescription" placeholder="请填入对惩罚的描述"></textarea><br>
