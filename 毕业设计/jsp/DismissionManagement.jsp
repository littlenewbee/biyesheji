...
<header>
	<div class="header">
		...
		<span class="title_con">离职管理</span>
		<span class="title_con1">欢迎   ${precord.employeeName }</span>
		<a class="logout" href="/毕业设计/login/login.html">LogOut</a>
	</div>
</header>
<div class="tips">请正确填写好离职员工相关信息</div>
<form action="/毕业设计/uploadDismissionManagement" method="get" >
<div class="con_input">
...
<div class="con_input">
	<span>离职日期：</span><input type="text" name="dismissionTime" class="easyui-datebox"/><br>
</div>
<div class="con_input">
	<span>理由描述：</span>
</div>
<textarea class="t2" rows="15" cols="50" name="reason" placeholder="请填入对员工离职的描述"></textarea><br>

	<input type="submit" class="submit" value="提交"/><input type="button" class="giveup" value="放弃提交"/>
</form>
