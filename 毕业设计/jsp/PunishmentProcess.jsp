...
<span class="personalinfo">员工惩罚申请单</span> 
</div>
<div class="container">
<form action="/毕业设计/uploadPunishmentProcess"method="get">
	<input type="hidden" name="employeeNum" value="${precord.employeeNum }"/>
	<input type="hidden" name="type" value="punishment"/>
	<textarea class="t2" rows="40" cols="60" name="description" placeholder="对员工惩罚及其理由原因的描述:"></textarea>
	<input type="button" class="submit" name="tijiao" value="提交"/><input type="button" name="return" class="qingkong" value="清空"/>
</form>
</div>
<div class="pop">
对不起，你不具有相应的权限
...
<script type="text/javascript" src="/毕业设计/js/EntryProcess.js"></script>
