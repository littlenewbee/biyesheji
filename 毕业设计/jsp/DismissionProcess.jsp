...
<span class="personalinfo">离职人员申请单</span> 
</div>
<div class="container">
<form action="/毕业设计/uploadDismissionProcess"method="get">
	<input type="hidden" name="employeeNum" value="${precord.employeeNum }"/>
	<input type="hidden" name="type" value="dismission"/>
	<textarea class="t2" rows="40" cols="60" name="description" placeholder="对员工离职的描述:"></textarea>
